        ...
        <div className={classes.card}>
          ...
          <Grid className={classes.infoContainer} container>
            ...
            <Grid className={classes.info} item lg={3}>
              ...
              <p className={classes.paragraph}>Todoc mantiene al paciente informado de sus citas vía email (sms y Whatsapp próximamente), así como de cualquier cambio que se presente en el proceso de atención.</p>
            </Grid>
          </Grid>
          <Grid className={classes.infoContainer} container>
            <Grid className={classes.info} item lg={3}>
